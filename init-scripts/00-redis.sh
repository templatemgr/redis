...
DATABASE_DIR="${DATABASE_DIR_REDIS:-/data/db/sqlite}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set webroot
WWW_ROOT_DIR="/usr/share/httpd/default"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Default predefined variables
DATA_DIR="/data/redis"   # set data directory
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/redis"
RUN_DIR="/run/redis"       # set scripts pid dir
...
SERVICE_USER="redis"  # execute command as another user
SERVICE_GROUP="redis" # Set the service group
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "$CONF_DIR/env/redis.sh" ] && . "$CONF_DIR/env/redis.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
root_user_name="${DATABASE_ROOT_USER:-root}"
root_user_pass="${DATABASE_ROOT_PASSWORD:-random}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  # replace variables
  __replace "REPLACE_DATABASE_DIR" "$DATABASE_BASE_DIR" "$CONF_DIR/redis.conf"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# root/admin user info [password/random]
#ENV_ROOT_USER_NAME="${ENV_ROOT_USER_NAME:-$REDIS_ROOT_USER_NAME}"   # root user name
#ENV_ROOT_USER_PASS="${ENV_ROOT_USER_NAME:-$REDIS_ROOT_PASS_WORD}"   # root user password
#root_user_name="${ENV_ROOT_USER_NAME:-$root_user_name}"                              #
#root_user_pass="${ENV_ROOT_USER_PASS:-$root_user_pass}"                              #
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#Normal user info [password/random]
#ENV_USER_NAME="${ENV_USER_NAME:-$REDIS_USER_NAME}"                  #
#ENV_USER_PASS="${ENV_USER_PASS:-$REDIS_USER_PASS_WORD}"             #
